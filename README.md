...
A modular **C++ trading system simulator** for carbon market trading. The project processes historical market data, detects arbitrage opportunities, performs risk validation, executes simulated trades, and logs trading activity. It is designed as a foundation for a high-performance trading engine.
